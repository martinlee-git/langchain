...
- 원문 문서: https://github.com/langchain-ai/langchain/blob/master/libs/partners/perplexity/README.md
- 미러 경로: `libs/partners/perplexity/README.md`
...
langchain perplexity [![PyPI 라이선스](https://img.shields.io/pypi/l/langchain)
